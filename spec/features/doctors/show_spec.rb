...
RSpec.describe "Doctors show page" do 
   ...
   it "has a button to remove a patient from the doctor's caseload" do 
      grey_sloan = Hospital.create!(name: "Grey Sloan Memorial")
      ...
      expect(page).to_not have_button("Remove #{patient3.name}")
   end

   it "takes the Doctor back to their show page where that patient is no longer listed" do 
      grey_sloan = Hospital.create!(name: "Grey Sloan Memorial")
      ...
      click_button "Remove Denny Duquette"
      expect(current_path).to eq("/doctors/#{mer.id}")
